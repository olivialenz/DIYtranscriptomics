...
output:
  ...
  pdf_document: #need to remove/change the ggplotly and datatable interactive objects
    fig_caption: yes
    toc: yes
vignette: >
  %\VignetteIndexEntry{DIYtranscriptomics}
...
load(file = "../data/targets.rda")
load(file = "../data/myDGEList.rda")
